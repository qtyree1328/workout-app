...
def enrich(data,metadata):
    ...
    put('pseudo-planche-push-up|pike-push-up|archer-push-up|diamond-push-up|handstand-push-up','chest|shoulders|triceps|arms','push','strength',aliases='press up|pressing|pushup')
    ...
    put('standing-band-hip-abduction','hips|glutes|outer hip|legs','hip-abduction','strength',True)
    ...
    put('goddess-squat|monk-squat','quads|glutes|hips|legs','squat','strength')
    ...
    put('standing-trunk-twists|standing-rotational-arm-swings','upper back|thoracic spine|spine','trunk-rotation','active-mobility')
    ...
    for e in data['exercises']:
        ...
        training=t['trainingType'];m['hold']=training in ['static-stretch','isometric','skill'] and m['hold']
        x=e.get('taxonomy')
